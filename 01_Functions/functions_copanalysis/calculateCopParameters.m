function copParameters = calculateCopParameters(copData, samplingfrequency)
...
% Processed Sway values
copParameters.Sway.Copx.swayAll = baseDataCopx;
copParameters.Sway.Copy.swayAll = baseDataCopy;
